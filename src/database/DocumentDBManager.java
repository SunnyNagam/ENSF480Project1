...
public class DocumentDBManager implements DBManager {
	...
	public ArrayList<Document> getObjects() {
		...
		documents.add(new Document(101, new ArrayList<String>(Arrays.asList((new String("Sunny, Keenan, Louis")).split(", "))), 15, "Friendship", 1, null, "This is a story about friendship, with so many ups and downs, its quite the exciting adventure!"));
		return documents;
	}
