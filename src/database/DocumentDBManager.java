...
public class DocumentDBManager implements DBManager {
	...
	public DocumentDBManager() {
		...
		documentDataBase.put("DisneyLand", new Document(123, authors123, 3, "Disneyland", 1, 1, contents123,15));
